...
public class TableModelForm extends AbstractTableModel {
	...
	private List<String> pieseString;
	...
	public TableModelForm(/*
						 ...
						 */List<BON> bon,List<String> operString, List<String> pieseString) {
		/*
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 12:
			return pieseString.get(rowIndex).toString();
		case 13:
