...
public class Factory {
		...
		private static bon_operImplDAO bonoperImplDAO = null;
		...
		private static PINLOCUITImplDAO pinlocuitImplDAO = null;
		...
		public bon_operImplDAO getbonoperDAO() {
			if (bonoperImplDAO == null) {
				bonoperImplDAO = new bon_operImplDAO();
			}
			return bonoperImplDAO;
		}
		...
		public PINLOCUITImplDAO getPinlocuitDAO() {
			if (pinlocuitImplDAO == null) {
				pinlocuitImplDAO = new PINLOCUITImplDAO();
			}
			return pinlocuitImplDAO;
		}
